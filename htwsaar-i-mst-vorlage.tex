...
%Einleitung
\cleardoublepage\include{Chapters/1-Einleitung/Einleitung}

%Grundlagen
\cleardoublepage\include{Chapters/2-Grundlagen/Grundlagen}

%Analyse
\cleardoublepage\include{Chapters/3-Analyse/Analyse}

%Konzeption
\cleardoublepage\include{Chapters/4-Tools/Tools}

%Implementierung
\cleardoublepage\include{Chapters/5-Fallstudie/Fallstudie}
